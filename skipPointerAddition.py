...
def add_Skip_List_Jumps(filename):
    with open(filename, "r") as f:
        ...
        for line in f:
            ...
            lengthOfPosting = int(currLine[1])
            ...
            for i, term in enumerate(currLine[2:], start=0):
...
def create_Skip_List(indexFile):
    ...
    # Writing to file
    with open('skiplist.txt', 'w') as f:        # Creates a new inverted index with skip jumps
...
if __name__ == '__main__':
    create_Skip_List('Index.txt') # Takes in the inverted index that was creating originally
